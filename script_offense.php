...
if(isset($_REQUEST['add_offense']))
  { 
	echo "<br>";
	$e_no=$_REQUEST['e_no'];
	if(isset($_REQUEST['success'])){ echo "<b class='w3-text-green w3-xxlarge'>Add Offense Success!!!</b>"; }
	echo "<table class='table' border='1'>";
	echo "<tr class='w3-dark-gray'><td colspan='2'>ADD OFFENSE DETAILS<br>".$_REQUEST['name']."</td></tr>";
	echo "<tr>
			<td>Offense Class</td>
			<form method='get'>
...
if(isset($_REQUEST['offense_history']))
  {
	...
	echo "<table class='table' border='1'>";
	echo "<tr class='w3-dark-gray'><td colspan='6'>OFFENSE HISTORY<br>".$_REQUEST['name']."</td></tr>";
	echo "<tr>
			<td>Offense Type</td>
			<td>Offense Class</td>
			<td>Reference</td>
