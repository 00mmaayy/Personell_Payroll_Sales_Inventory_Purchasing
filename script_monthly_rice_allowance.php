...
<body>
    ...
    <?php if ($print_company == 'ALC') : ?>
        <div class="alc-container">
            ...
            <div class="alc-title flex">
                <div class="title-name">Employee</div>
                <div>Daily Allowance</div>
                <div>Attendance (HRS)</div>
                <div>Absences (HRS)</div>
                <div>Lates (HRS)</div>
                <div>Undertime (HRS)</div>
            ...
            <div class="data-container">
                <?php for ($i = 0; $i < count($employee_alc); $i++) :
                    ...
                    <div class="data-content flex">
                        ...
                        <div><?php echo number_format($daily_allowance, 2); ?></div>
                        <div><?php echo number_format($hours, 2); ?></div>
                        <div><?php echo number_format($absent, 2); ?></div>
                        <div><?php echo number_format($lates, 2); ?></div>
                        <div><?php echo number_format($undertime, 2); ?></div>
                        <div><?php echo number_format($hours_total, 2); ?></div>
                        <div><?php echo number_format($days_total, 2); ?></div>
                        <div><?php echo number_format($allowance_total, 2); ?></div>
                        <div><?php echo number_format($allowance_rice, 2); ?></div>
                    </div>
                <?php endfor; ?>
                <div class="data-footer flex">
                    <div class="data-name">Total</div>
                    <div><?php echo number_format($daily, 2); ?></div>
                    <div><?php echo number_format($hrs_total, 2); ?></div>
                    <div><?php echo number_format($abs_total, 2); ?></div>
                    <div><?php echo number_format($lte_total, 2); ?></div>
                    <div><?php echo number_format($und_total, 2); ?></div>
                    <div><?php echo number_format($att_total, 2); ?></div>
                    <div><?php echo number_format($dys_total, 2); ?></div>
                    <div><?php echo number_format($all_total, 2); ?></div>
