...
$select_delivered = mysql_query("SELECT sbd.dr_date,
								...
								WHERE $range 
									    sj.jo_payment_amount!=(sbd.dr_qty * sbd.b_amount) 
...
<div class="w3-container">
	...
	<tr class="w3-green" align="center"><td style="text-align: center" colspan="9">STATEMENT OF ACCOUNT</td></tr>
	<tr>
		<td>CLIENT NAME</td>
			<td colspan="6"><?php echo $result_client_details['name']; ?></td>
		
		<td>SOA NO.</td>
	</tr>
	<tr>
		<td>ADDRESS</td>
			<td colspan="6"><?php echo $result_client_details['address']; ?></td>
		
		
		<td>DATE</td>
			<td><?php echo date('F d, Y'); ?></td>
	</tr>
	<tr><td>TIN</td><td colspan="8"><?php echo $result_client_details['tin']; ?></td></tr>
		<tr align='center'>
			<th>DR DATE</th>
			<th>DR NO</th>
			<th>JO NO/BK NO</th>
		...
		<tr>
			<td class="grand-amount-label" colspan='7' style="text-align: right"><b>TOTAL AMOUNT DUE(VAT Inclusive)&nbsp;</b></td>
