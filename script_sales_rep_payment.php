<?php
if(isset($_REQUEST['search']) and $_REQUEST['search']=="payment")
{
	...
	echo "<table align='center' class='w3-tiny table'>
		...
		<?php echo "<i><span class='w3-red w3-text-white'>&nbsp;JO WITH PAYMENTS ONLY: </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Report from</i> <b>".date('F d, Y',strtotime($_REQUEST['sdate']))."</b> <i>to</i> <b>".date('F d, Y',strtotime($_REQUEST['edate']))."</b>
				</td>
			</tr>
			<tr class='w3-green'>
				<td>count</td>
		...
		do
		{
		 echo "<tr class='w3-hover-pale-red'>
		  ...
		  echo "<td align='center'>".$r['rs_no']."</td>
		        <td align='center'>".$r['or_no']."</td>
